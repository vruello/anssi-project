...
class MetasploitModule < Msf::Post
  def initialize(info={})
    ...
    register_options(
      [
        OptInt.new('DELAY', [true, 'Interval between screenshots in seconds', 0]),
        ...
        OptString.new('PATH', [false, 'Place to record screenshot (full filename)', "/root/tmp"])
      ])
  end
  ...
  # HOMEMADE
  def store_screenshot(path, data)
      ...
      count.times do |num|
        ...
        if data
          ...
          if record?
            ...
            file_locations << store_screenshot(datastore['PATH'], data)
          end
